...
<body id="page-top">
                    ...
                    <!-- <div class="row d-flex shadow p-2">
                        <form class="d-none d-sm-inline-block form-inline ml-md-3 my-2 my-md-0 mw-100 navbar-search border">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" id="searchQuery" onclick="cariDaftarEmployee()">
    ...
    <script src="<?= BASE_URL_HTML ?>/operational/reservation/reservation.js"></script>
    <!-- Toastr JS -->
