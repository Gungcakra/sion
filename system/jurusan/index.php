...
<body id="page-top">
                    ...
                    <div class="row d-flex shadow p-2">
                        <form class="d-none d-sm-inline-block form-inline ml-md-3 my-2 my-md-0 mw-100 navbar-search border">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Jurusan" aria-label="Search" aria-describedby="basic-addon2" id="searchQuery" onkeyup="cariDaftarJurusan()" autocomplete="off">
                                <div class="input-group-append">
                                    <button class="btn btn-primary" type="button" onclick="cariDaftarJurusan()">
                        ...
                        <div class="ml-2 ">
                            <select class="custom-select" id="limit" name="limit" onclick="cariDaftarJurusan()">
                        ...
                        <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm ml-auto" data-toggle="modal" data-target="#jurusanModal">
                            <i class="fas fa-plus fa-sm text-white"></i> Tambah Jurusan
                        </button>
                    </div>
    ...
    <script src="<?= BASE_URL_HTML ?>/system/jurusan/jurusan.js"></script>
    <!-- Toastr JS -->
