...
<body id="page-top">
                    ...
                    <div class="row d-flex shadow p-2">
                        <form class="d-none d-sm-inline-block form-inline ml-md-3 my-2 my-md-0 mw-100 navbar-search border">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Nama Pegawai" aria-label="Search" aria-describedby="basic-addon2" id="searchQuery" onkeyup="cariDaftarPegawai()" autocomplete="off">
                                <div class="input-group-append">
                                    <button class="btn btn-primary" type="button" onclick="cariDaftarPegawai()">
                        ...
                        <div class="ml-2 col-2 p-0">
                            <select class="custom-select" id="idJabatanSearch" name="idJabatanSearch" onclick="cariDaftarPegawai()">
                                <option value="" select>Semua Jabatan</option>
                                <?php
                                foreach ($jabatan as $kl) {

                                ?>
                                    <option value="<?= $kl['idJabatan'] ?>"><?= $kl['nama'] ?></option>
                                <?php  } ?>
                            </select>
                        </div>
                        <!-- <div class="ml-2 ">
                            <select class="custom-select" id="idAngkatanSearch" name="idAngkatanSearch" onclick="cariDaftarPegawai()">
                        ...
                        <div class="ml-2 ">
                            <select class="custom-select" id="limit" name="limit" onclick="cariDaftarPegawai()">
                        ...
                        <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm ml-auto" data-toggle="modal" data-target="#pegawaiModal">
    ...
    <script src="<?= BASE_URL_HTML ?>/system/pegawai/pegawai.js"></script>
    <!-- Toastr JS -->
